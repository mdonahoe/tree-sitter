...
tree_print: libtree-sitter.a
	gcc -o tree_print tree_print.c grammars/c/src/parser.c grammars/python/src/parser.c grammars/python/src/scanner.c -I lib/include -I grammars/python/src -L . -l:libtree-sitter.a
